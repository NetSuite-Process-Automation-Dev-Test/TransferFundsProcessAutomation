...
public class ExtentReportListener {
	...
	public static ExtentReports setUp() {
		...
		report = new ExtentSparkReporter(System.getProperty("user.dir") + "/Extent_report/Transfer Funds Process Automation.html");
		report.config().setDocumentTitle("Transfer Funds Process Automation"); // Tile of report
		report.config().setReportName("Transfer Funds Process Automation"); // Name of the report
